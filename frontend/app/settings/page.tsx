...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-20 sm:pt-24 pb-12 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-extrabold mb-6 sm:mb-8 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-500">
          Account Settings
        </h1>

        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 backdrop-blur-sm">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-purple-400">Followed Games</h2>
          <p className="text-gray-400 mb-4 sm:mb-6 text-sm sm:text-base">Select the games you want to see on your dashboard and receive notifications for.</p>
          ...
          <div className="flex flex-wrap gap-3">
            {AVAILABLE_GAMES.map(game => (
              <button
                ...
                className={`px-4 py-2 rounded-lg font-bold text-sm transition-all duration-300 ${games.includes(game)
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 backdrop-blur-sm">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 text-cyan-400">Discord Notifications</h2>
          <p className="text-gray-400 mb-4 sm:mb-6 text-sm sm:text-base">Get live match alerts sent directly to your Discord. Choose the method that works best for you.</p>

          {/* Method tabs */}
          <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
            <button
              onClick={() => setNotifMethod('bot')}
              className={`px-4 py-2 rounded-lg font-bold text-sm transition-all duration-300 ${notifMethod === 'bot'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-bold text-sm transition-all duration-300 ${notifMethod === 'webhook'
                  ? 'bg-cyan-500 text-black shadow-[0_0_15px_rgba(6,182,212,0.4)]'
                  : 'bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white'
                }`}
            >
